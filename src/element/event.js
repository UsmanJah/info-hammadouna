...
/* ══════════════════════════════════════════════════════
   PALETTE MARQUE
   Verts  : #0c6938 · #13894f · #00bf63
   Blanc  : #f9fbfd
   Ors    : #dcb626 · #e8be21 · #caa127
══════════════════════════════════════════════════════ */
const BRAND = {
  greenDark:  "#0c6938",
  greenMid:   "#13894f",
...
/* ══════════════════════════════════════════════════════
   UTILITAIRES DATE
   Supporte : "dd/mm/yyyy", "d/m/yyyy", "yyyy-mm-dd"
══════════════════════════════════════════════════════ */
...
function formatDateFR(str) {
  const p = parseParts(str);
  if (!p) return str || "—";
  return `${p.day} ${MONTHS[p.monthIdx] ?? "???"} ${p.year}`;
}
...
/* ══════════════════════════════════════════════════════
   CARTE HÉRO — Prochain évènement mis en évidence
══════════════════════════════════════════════════════ */
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hov
          ? `0 24px 56px rgba(12,105,56,0.45), 0 0 0 3px ${BRAND.goldMid}88`
          : `0 12px 40px rgba(12,105,56,0.3), 0 0 0 2px ${BRAND.goldMid}44`,
    ...
    >
      ...
      <div style={{ padding:"28px 28px 24px", position:"relative", zIndex:1 }}>
        {/* Top row : badge "Prochain" + catégorie */}
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:18, flexWrap:"wrap", gap:8 }}>
          {/* Pill "Prochain évènement" */}
        ...
        <div style={{ display:"flex", gap:24, alignItems:"center", flexWrap:"wrap" }}>
          ...
          <div style={{ flexGrow:1, minWidth:0 }}>
            <h2 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:"clamp(20px,3vw,26px)", fontWeight:700, color:"#fff", lineHeight:1.25, marginBottom:10 }}>
              {event.title}
            </h2>
            <div style={{ display:"flex", flexDirection:"column", gap:6 }}>
              <span style={{ display:"flex", alignItems:"center", gap:6, fontSize:13, color:"rgba(255,255,255,0.8)" }}>
                <IcoClock c="rgba(255,255,255,0.7)"/>{event.heure}
              </span>
              <span style={{ display:"flex", alignItems:"center", gap:6, fontSize:13, color:"rgba(255,255,255,0.8)" }}>
                <IcoPin c="rgba(255,255,255,0.7)"/>{event.lieu}
              </span>
            </div>
          </div>
          ...
          <div style={{ flexShrink:0 }}>
            <button
              style={{
                background: hov
                  ? `linear-gradient(135deg,${BRAND.goldLight},${BRAND.goldDark})`
                  : `linear-gradient(135deg,${BRAND.goldMid},${BRAND.goldDark})`,
                ...
                transition: "all 0.2s",
                whiteSpace: "nowrap",
                boxShadow: `0 6px 20px ${BRAND.goldDark}66`,
                letterSpacing: 0.3,
              }}
            >
...
/* ══════════════════════════════════════════════════════
   CARTE ÉVÈNEMENT STANDARD (minimaliste)
══════════════════════════════════════════════════════ */
  ...
  return (
    <div
      ...
      style={{
        ...
        padding:"16px 20px",
        cursor:"pointer",
        border:`1.5px solid ${hov ? BRAND.greenLight + "66" : "#edf2ef"}`,
        boxShadow: hov ? `0 10px 28px rgba(12,105,56,0.1)` : "0 2px 8px rgba(0,0,0,0.04)",
    ...
    >
      ...
      <div style={{ flexGrow:1, minWidth:0 }}>
        ...
        <div style={{ fontSize:14, fontWeight:700, color:"#0f172a", fontFamily:"'Cormorant Garamond',serif", marginBottom:4, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>
          {event.title}
        </div>
...
function DetailModal({ event, onClose }) {
  ...
  return (
    <div
      style={{ background:"#fff", borderRadius:24, maxWidth:500, width:"100%", position:"relative", overflow:"hidden", boxShadow:"0 40px 100px rgba(0,0,0,0.22)", animation:"scaleIn 0.25s cubic-bezier(0.34,1.4,0.64,1) both" }}
    ...
    >
      ...
      <div style={{ background: isNext ? `linear-gradient(135deg,${BRAND.greenDark},${BRAND.greenMid})` : `linear-gradient(135deg,${c.dot}22,${c.dot}08)`, borderBottom: isNext ? "none" : `1.5px solid ${c.dot}25`, padding:"28px 28px 24px", position:"relative" }}>
        ...
        {/* Badge compte à rebours si futur */}
        {delta >= 0 && (
          <div style={{ marginBottom:10 }}>
            <span style={{ display:"inline-flex", alignItems:"center", gap:5, background:`linear-gradient(90deg,${BRAND.goldDark},${BRAND.goldMid})`, borderRadius:99, padding:"3px 12px" }}>
              ...
              <span style={{ fontSize:11, fontWeight:700, color:"#fff" }}>
                {delta === 0 ? "Aujourd'hui !" : delta === 1 ? "Demain" : `Dans ${delta} jours`}
              </span>
            </span>
          </div>
        )}
        ...
        <h2 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:22, fontWeight:700, color: isNext ? "#fff" : "#0f172a", lineHeight:1.3, paddingRight:32 }}>
          {event.title}
        </h2>
      </div>
      ...
      <div style={{ padding:"22px 28px 26px" }}>
        ...
        {/* <button style={{ width:"100%", background:`linear-gradient(135deg,${BRAND.greenMid},${BRAND.greenDark})`, color:"#fff", border:"none", borderRadius:12, padding:"13px 24px", fontSize:14, fontWeight:700, cursor:"pointer", fontFamily:"'Outfit',sans-serif", display:"flex", alignItems:"center", justifyContent:"center", gap:8, boxShadow:`0 6px 20px rgba(12,105,56,0.35)` }}>
          S'inscrire à l'évènement <IcoArrow />
        </button> */}
      </div>
    </div>
  );
  ...
  return (
    <div
      ...
      style={{
        ...
        padding:"14px 18px",
        background: hov ? "#f0faf4" : BRAND.white,
        borderRadius:13,
        border:`1.5px solid ${hov ? BRAND.greenLight + "66" : "#edf2ef"}`,
        cursor:"pointer",
        transition:"all 0.2s ease",
        animation:`fadeUp 0.3s ease ${Math.min(delay,0.4)}s both`,
        position:"relative", overflow:"hidden",
      }}
    >
...
export default function Event() {
  ...
  const sorted = useMemo(() =>
    [...(eventsData.events || [])].sort((a,b) => parseDate(a.date) - parseDate(b.date)),
  []);

  // Prochain évènement (le 1er à venir)
  const nextEvent = useMemo(() =>
    sorted.find(e => parseDate(e.date) >= today) || null,
  [sorted, today]);

  // Les 4 suivants (après le prochain)
  ...
  return (
    <div style={{ minHeight:"100vh", background:BRAND.white, fontFamily:"'Outfit',sans-serif", position:"relative" }}>
      ...
      <div style={{ maxWidth:800, margin:"0 auto", padding:"60px 24px 80px", position:"relative", zIndex:1 }}>
        ...
        <div style={{ marginBottom:36, animation:"fadeUp 0.5s ease both" }}>
          ...
          <div style={{ display:"flex", alignItems:"flex-end", justifyContent:"space-between", flexWrap:"wrap", gap:16 }}>
            <div>
              <h1 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:"clamp(30px,5vw,50px)", fontWeight:700, color:BRAND.greenDark, lineHeight:1.1, marginBottom:6 }}>
                Évènements à venir
              </h1>
              <p style={{ fontSize:13, color:"#6b8f76", lineHeight:1.6 }}>
                Prochains rassemblements de la communauté
              </p>
            </div>

            <button
              onClick={() => setShowPanel(true)}
              onMouseEnter={e => { e.currentTarget.style.background=BRAND.greenDark; }}
              onMouseLeave={e => { e.currentTarget.style.background=BRAND.greenMid; }}
        ...
        {/* ══ PROCHAIN ÉVÈNEMENT (HERO) ════════════════════════════════════ */}
        {nextEvent && (
          <HeroEventCard event={nextEvent} onClick={setDetail} />
        )}

        {/* ══ 4 ÉVÈNEMENTS SUIVANTS ════════════════════════════════════════ */}
          ...
          <>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
              {upcomingRest.map((ev, i) => (
                <EventCard key={ev.id} event={ev} onClick={setDetail} delay={i * 0.07} />
              ))}
            </div>
          </>
        )}
        ...
        {sorted.length > 5 && (
          <div style={{ textAlign:"center", marginTop:28, animation:"fadeUp 0.5s ease 0.4s both" }}>
            <button
              onClick={() => setShowPanel(true)}
              style={{ background:"none", border:"none", color:BRAND.greenMid, fontSize:13, fontWeight:600, cursor:"pointer", display:"inline-flex", alignItems:"center", gap:6, opacity:0.8, fontFamily:"'Outfit',sans-serif" }}
              onMouseEnter={e => e.currentTarget.style.opacity="1"}
              onMouseLeave={e => e.currentTarget.style.opacity="0.8"}
            >
              Voir les {sorted.length} évènements <IcoArrow c={BRAND.greenMid}/>
            </button>
          </div>
        )}
      </div>
          ...
          <div style={{ position:"relative", width:"min(780px,100vw)", height:"100vh", background:BRAND.white, display:"flex", flexDirection:"column", animation:"slideIn 0.32s cubic-bezier(0.34,1.1,0.64,1) both", boxShadow:"-16px 0 48px rgba(0,0,0,0.15)" }}>
            ...
            <div style={{ background:"#fff", borderBottom:"1px solid #e4ede7", padding:"20px 26px", display:"flex", alignItems:"center", justifyContent:"space-between", flexShrink:0 }}>
              <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                <div style={{ width:38, height:38, borderRadius:10, background:`linear-gradient(135deg,${BRAND.greenLight},${BRAND.greenDark})`, display:"flex", alignItems:"center", justifyContent:"center", boxShadow:`0 4px 12px rgba(12,105,56,0.35)` }}>
                  <IcoCalBig/>
                </div>
                <div>
              ...
              <div style={{ marginBottom:12 }}>
                ...
                <div style={{ display:"flex", gap:6, flexWrap:"wrap" }}>
                  {["Tous", ...years.map(String)].map(y => {
                    ...
                    return (
                      <button key={y} onClick={() => setFilterYear(y)} style={{ padding:"5px 14px", borderRadius:99, fontSize:12, fontWeight:700, cursor:"pointer", fontFamily:"'Outfit',sans-serif", transition:"all 0.15s", border: active ? "none" : `1.5px solid #dde8e0`, background: active ? BRAND.greenMid : "#fff", color: active ? "#fff" : "#4a7a5a" }}>
                        {y}
                      </button>
                    );
                  })}
              ...
              <div>
                ...
                <div style={{ display:"flex", gap:6, flexWrap:"wrap" }}>
                  {["Tous", ...categories].map(cat => {
                    ...
                    return (
                      <button key={cat} onClick={() => setFilterCat(cat)} style={{ padding:"5px 14px", borderRadius:99, fontSize:12, fontWeight:700, cursor:"pointer", fontFamily:"'Outfit',sans-serif", transition:"all 0.15s", border: active ? "none" : `1.5px solid #dde8e0`, background: active ? (cc ? cc.dot : BRAND.greenMid) : "#fff", color: active ? "#fff" : "#4a7a5a" }}>
                        {cat}
                      </button>
                    );
                  })}
              ...
              {panelEvents.length === 0 ? (
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
                  {panelEvents.map((ev, i) => (
                    <PanelRow key={ev.id} event={ev} onClick={setDetail} delay={i * 0.02} />
                  ))}
                </div>
              )}
            </div>
      ...
      {detail && (
        <div
          style={{ position:"fixed", inset:0, zIndex:300, display:"flex", alignItems:"center", justifyContent:"center", padding:20, animation:"fadeIn 0.18s ease" }}
